    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('hodapproval', models.CharField(blank=True, max_length=10, null=True)),
                ('hodemail', models.CharField(blank=True, max_length=150, null=True)),
                ('director_approval', models.CharField(blank=True, max_length=150, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('issuetype', models.CharField(blank=True, max_length=150, null=True)),
                ('issuetdate', models.DateField(blank=True, null=True)),
                ('issuetdestination', models.CharField(blank=True, max_length=150, null=True)),
                ('issuelink', models.CharField(blank=True, max_length=250, null=True)),
                ('carchoose', models.CharField(blank=True, max_length=50, null=True)),
                ('cartype', models.CharField(blank=True, max_length=50, null=True)),
                ('carplateno', models.CharField(blank=True, max_length=50, null=True)),
                ('createby', models.CharField(blank=True, max_length=150, null=True)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
