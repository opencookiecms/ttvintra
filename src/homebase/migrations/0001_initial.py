...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('travelrequest', models.CharField(blank=True, max_length=20, null=True)),
                ('shipmentrequest', models.CharField(blank=True, max_length=20, null=True)),
                ('ncar', models.CharField(blank=True, max_length=20, null=True)),
